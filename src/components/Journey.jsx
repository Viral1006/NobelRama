...
const openWinnersPage = () => {
  ...
  return ( 
    <div className='bg-[#443c68] overflow-visible w-full h-[60vh] smmax:h-screen flex flex-col items-start justify-center'>
      <div className='font-abril text-[40px] text-left flex-col-start ml-48 smmax:m-auto smmax:text-[30px] smmax:p-10 text-[#ffffff]  mt-1'>
      ...
      <div className='flex ml-48 mt-4 smmax:m-auto smmax:mx-10 smmax:mb-40 '>
