  ...
  return ( 
    <div className='bg-[#443c68] overflow-visible w-full h-[60vh] flex flex-col items-start justify-center'>
      ...
      <div className='flex ml-48 mt-4'>
        <button className='mr-4 bg-[#635985] hover:bg-[#333333] text-white font-zilla-slab font-normal py-2 px-4 rounded-lg transition-transform duration-300 transform hover:scale-110'>
          Explore Winners
        </button>
...
//   const handleExploreWinnersClick = () => {
//     navigate('/Winners'); // Redirect to the Winners page
//   };
...
//       </div>
//       <div className='flex ml-48 mt-4'>
//         <button onClick={handleExploreWinnersClick} className='mr-4 bg-[#635985] text-white font-zilla-slab font-normal py-2 px-4 rounded-lg transition-transform duration-300 transform hover:scale-110'>
//           Explore Winners
//         </button>
//         <Link to="/Winners">
